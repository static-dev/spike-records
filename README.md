...
[![coverage](https://coveralls.io/repos/github/static-dev/spike-records/badge.svg?branch=locals)](https://coveralls.io/github/static-dev/spike-records?branch=locals)
